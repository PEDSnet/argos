...
argos$set(
  'public', 'add_site',
  #' @name add_site-method
  #' @inherit add_site
  function(f_tbl,
           site_tbl = self$cdm_tbl('person'),
           id_col = 'person_id') {
...
argos$set(
  'public', 'lookback_facts',
  #' @name lookback_facts-method
  #' @inherit lookback_facts
  function(data, index_tbl, event_date_col = NA,
           index_date_col = 'cohort_start_date', link_col = 'person_id',
           lookback = 365L) {
